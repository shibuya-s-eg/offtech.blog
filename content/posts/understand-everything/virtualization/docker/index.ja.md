...
{{< image src="container-info.png" width="800px" height="600px" caption="" >}}
{{< image src="container-info-2.png" width="800px" height="600px" caption="" >}}
{{< image src="docker-raw-socket.png" width="800px" height="600px" caption="" >}}
{{< image src="hellow-nginx.png" width="800px" height="600px" caption="" >}}
{{< image src="hellow-world.png" width="800px" height="600px" caption="" >}}
{{< image src="hellow-nginx-container.png" width="800px" height="600px" caption="" >}}
{{< image src="localhost-8080.png" width="800px" height="600px" caption="" >}}
{{< image src="nginx-container-data.png" width="800px" height="600px" caption="" >}}
{{< image src="nginx-container-log.png" width="800px" height="600px" caption="" >}}
{{< image src="nginx-dockerfile.png" width="800px" height="600px" caption="" >}}
{{< image src="overlay2.png" width="800px" height="600px" caption="" >}}

Portはなになにです。なになにしています。
こちらをビルドしていきます。

Docker buildの画像

ベースイメージに対して、Dockerfileに記載した各行がレイヤーとして加えられています。
これで最終的なカスタムイメージが完成しました。

docker imagesの画像

サイズがわずかに大きくなっていることが分かります。

ファイルシステム上でこのイメージの実体も確認しておきましょう。
ローカルリポジトリのイメージは/var/にあります。
